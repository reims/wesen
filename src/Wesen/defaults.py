...
DEFAULT_WORLD_LENGTH = 400;

DEFAULT_WESEN_SOURCES = "Rincewind,Nightwatch,Dwarf";
DEFAULT_WESEN_COUNT = 10;
DEFAULT_WESEN_ENERGY = 100;
DEFAULT_WESEN_MAXAGE = 200;

DEFAULT_FOOD_COUNT = 5*DEFAULT_WESEN_COUNT;
DEFAULT_FOOD_AMOUNT = 1;
DEFAULT_FOOD_MAXAMOUNT = DEFAULT_WESEN_ENERGY * 100;
DEFAULT_FOOD_MAXAGE = DEFAULT_WESEN_MAXAGE * 10;
DEFAULT_FOOD_SEEDRATE = 0.002;
